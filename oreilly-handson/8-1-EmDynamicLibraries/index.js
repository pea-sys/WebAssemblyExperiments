...
function validateProduct(productId) {
  ...
  const isValid = orderModule.ccall("ValidateProduct", "number", ["string", "number", "number"], [productId, arrayPointer, arrayLength]);
...
function validateQuantity(quantity) {
  const isValid = orderModule.ccall("ValidateQuantity", "number", ["string"], [quantity]);
