...
["_strlen","_atoi","_malloc","_ValidateValueProvided","_IsIdInArray","___wasm_apply_data_relocs","_fflush","onRuntimeInitialized"].forEach((prop) => {
...
var wasmBinaryFile;
  wasmBinaryFile = 'validate_core.wasm';
...
// end include: preamble.js
  ...
  function loadWebAssemblyModule(binary, flags, handle) {
      ...
      function loadModule() {
        ...
        if (firstLoad) {
          ...
          memAlign = Math.max(memAlign, 16); // we at least need stack alignment
          // prepare memory
  ...
  /** @param {number=} handle */
  function loadDynamicLibrary(lib, flags = {global: true, nodelete: true}, handle) {
